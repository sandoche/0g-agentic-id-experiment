...
export const usdR = cashAsset(4663),
	usdB = cashAsset(56),
	usdBase = cashAsset(8453);
...
export function holding(
	...
	return {
		asset,
		units: tokens * 10n ** BigInt(asset.decimals),
		priceUsd,
		observedAt: 100000,
	};
}
export function snapshot(
	...
	return {
		...
		complete: true,
		holdings: [
			holding(tao, taoTokens),
			holding(zero, zeroTokens),
			holding(usdR, rhCash),
			holding(usdB, bnbCash),
			holding(usdBase, baseCash),
		],
	};
}
