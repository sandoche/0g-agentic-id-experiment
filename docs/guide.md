# 0g Agentic ID Experiment — Operator Guide
...
file and follow the [minimal persistence operator runbook](minimal-persistence.md).
...
separate ignored file. See the [operator runbook](minimal-persistence.md) for
...
[containment and recovery](minimal-persistence.md#containment-and-recovery).
